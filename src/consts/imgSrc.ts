...
const imgSrc = {
  ...
  유물무기: `${itemBaseFolder}/유물무기.png`,
  유물무기2: `${itemBaseFolder}/유물무기2.png`,
  유물방어구: `${itemBaseFolder}/유물방어구.png`,
  유물방어구2: `${itemBaseFolder}/유물방어구2.png`,
  고대무기: `${itemBaseFolder}/고대무기.png`,
  고대무기2: `${itemBaseFolder}/고대무기2.png`,
  고대방어구: `${itemBaseFolder}/고대방어구.png`,
  고대방어구2: `${itemBaseFolder}/고대방어구2.png`,
  ...
  상위고대무기: `${itemBaseFolder}/상위고대무기.png`,
  상위고대무기2: `${itemBaseFolder}/상위고대무기2.png`,
  상위고대방어구: `${itemBaseFolder}/상위고대방어구.png`,
  상위고대방어구2: `${itemBaseFolder}/상위고대방어구2.png`,
